...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        .setDescription("`B.backup create` -- *saves from this server*\n`B.backup load <ID>` -- *Loads in&from this server*\n`B.backup info <ID>` -- *Shows info of this backup*\n`B.backup list [SERVERID]` -- *Shows list of this/other Server*\n`B.backup loadother <SERVERID> <ID>` -- *Loads Backup from Different Server*")
